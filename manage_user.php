<?php
    ...
    if (! empty($passwordErrors)) {
        ...
        echo "<script>alert('Password requirements not met:\\n- $error_message'); window.location='manage_user.php';</script>";
        exit();
    }
...
<body>
  ...
  <?php include 'aside.php'; ?>
    ...
    <!-- MODAL: ADD NEW USER with Password Validation -->
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="manage_user.php" method="POST" id="addUserForm">
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="add_password" class="form-control" placeholder="Create Password" required>
                            <div class="password-requirements">
                                <div class="requirement-title">Password must contain:</div>
                                <ul>
                                    <li id="add_charCount">✓ Minimum 8 characters</li>
                                    <li id="add_letterCheck">✓ At least 1 letter (A-Z, a-z)</li>
                                    <li id="add_numberCheck">✓ At least 1 number (0-9)</li>
                                    <li id="add_specialCheck">✓ At least 1 special character (!@#$%^&* etc.)</li>
                                </ul>
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer border-0 p-4 pt-0">
                        ...
                        <button type="submit" name="add_user_submit" class="btn btn-add px-4" id="addUserBtn" disabled>Create Account</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        function validateAddPassword() {
            ...
            const charCount = document.getElementById('add_charCount');
            ...
            const letterCheck = document.getElementById('add_letterCheck');
            ...
            const numberCheck = document.getElementById('add_numberCheck');
            ...
            const specialCheck = document.getElementById('add_specialCheck');
        ...
        if (addPasswordInput) {
            addPasswordInput.addEventListener('input', validateAddPassword);
        }
